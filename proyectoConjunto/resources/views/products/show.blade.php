...
@section('cuerpo')
    ...
    <script>
        ...
        let zFondos150 = ["url('/images/{{$product->images[1]->path}}')", "url('/images/{{$product->images[0]->path}}')"];
        let zFondos600 = ["url('/images/{{$product->images[1]->path}}')", "url('/images/{{$product->images[0]->path}}')"];
